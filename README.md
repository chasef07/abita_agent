...
| TTS | Rime plugin `coda` | Speaker defaults to `pilaster`; east-region Rime endpoint; 16 kHz PCM |
...
| `RIME_TTS_SPEAKER` | Optional TTS speaker override; defaults to `pilaster` |
