...
- One to three sentences at a time. Exception: registration read-backs and appointment confirmations can be longer — read all key details in one pass.
