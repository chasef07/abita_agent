...
- When giving an address, put `<break time="300ms"/>` between the street, city and state, and zip code. If the caller asks you to spell the address, use `<spell>...</spell>` for the spelled address parts.
