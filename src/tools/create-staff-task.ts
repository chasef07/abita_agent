...
const taskParameters = z.object({
  category: z
    ...
    .describe(
      "optical includes glasses/contact prescriptions, frames and lens orders; medication includes refills and medication authorizations; " +
        "appointments includes vision appointment eligibility and coverage; insurance includes medical copays, coverage, referral requirements and service authorizations; referrals means specialist/imaging orders. " +
