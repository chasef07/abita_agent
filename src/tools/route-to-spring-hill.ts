...
export const route_to_spring_hill = tool({
  ...
  description:
    ...
    "Spring Hill-only visits include pediatric ophthalmology or callers implied to be under 18, routine eye exams, glasses prescriptions, contact lens prescriptions, and insurance accepted at Spring Hill but not Crystal River. " +
    "Do not call this for Crystal River cataract evaluations; Dr. Licht evaluates cataracts in Crystal River and the office coordinates with Spring Hill for testing that cannot be done there. " +
