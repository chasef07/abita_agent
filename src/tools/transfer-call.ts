...
export const transfer_call = llm.tool({
  description:
    ...
    "Call this for prescription verification or update requests, medical records, surgery coordination, clinical or emergency symptoms, asking for a specific person, returning a missed call or received call from this number, status of glasses or contacts already ordered, or when the caller still insists after you try to help. " +
