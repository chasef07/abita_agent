...
export const transfer_call = llm.tool({
  description:
    ...
    "Call this for prescription questions, medical records, surgery coordination, clinical or emergency symptoms, returning a specific person's call, status of glasses or contacts already ordered, or when the caller still insists after you try to help. " +
